...
internal class BotsiAiGoogleStoreHelper(
    ...
    @JvmSynthetic
    fun acknowledgePurchase(purchase: BotsiAiPurchase) =
        flow {
    ...
    @JvmSynthetic
    fun consumePurchase(purchase: BotsiAiPurchase) =
        flow {
    ...
    private fun createException(billingResult: BillingResult, where: String): BotsiAiException {
        val message = errorMessageFromBillingResult(billingResult, where)
        return BotsiAiException(
            message = message,
